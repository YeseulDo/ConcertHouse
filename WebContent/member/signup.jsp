...
<script type="text/javascript">
	...
	/* 
		Email주소 입력 시 실행되는 메서드
		1. ajax로 DB와 중복검사 후
		2. 인증메일 전송 및 인증번호 입력 페이지 팝업
	*/
    function authEmail(){
...
<body>
	...
	<!-- 회원 정보 입력 폼 -->
	<form action="signup_proc.jsp" class="needs-validation" method="post" onsubmit="return checkForm();">
	<div class="container" id="container">
		...
		<div class="order-md-1">
				...
				<div class="mb-3">
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<input type="button" id="authBtn" class="btn btn-secondary" onclick="authEmail()" value="Authorize">
						</div>
					</div>
				</div>
				...
				<div class="mb-3">
					...
					<input type="password" class="form-control" id="password2" name="password2" onblur="checkPwd2()" > 
				</div>
				...
				<div class="row">
					...
					<div class="col-md-7 mb-3">
						...
						<input type="text" class="form-control" id="address1" name="address1" value="" readonly>
					</div>
				</div>

				<div class="mb-5">
					<label for="address2">&nbsp;주소</label>
					<input type="text" class="form-control" id="address2" name="address2" placeholder="나머지 주소를 입력하세요:-)"	required="">
				</div>

				<hr class="mb-5">
				<input class="btn btn-dark btn-lg btn-block" type="submit" value="회원가입">
			</div>
